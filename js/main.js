...
TweenMax.from(".menu-social-warp", 2, {
    delay: 2.2,
    opacity: 0,
    y: 20,
    ease: Expo.easeInOut
...
window.addEventListener('load', function () {
    $('body').append('<audio autoplay loop volume="0.6" id="audio"><source src="som.mp3" type="audio/mpeg"/></audio>');
});
